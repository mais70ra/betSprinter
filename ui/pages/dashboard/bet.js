  ...
  function tweenInitiation(msg) {
    ...
    tween.to(lineAnimation, duration, {
      ...
      onStart: function() {
        ...
        if (msg.chosenPlayer && msg.chosenAmount) {
          betObject.playerNumber = msg.chosenPlayer;
          betObject.amount = msg.chosenAmount;
          let selectedPlayer = document.getElementById("player" + msg.chosenPlayer);
          let selectedAmount = document.getElementById("amount" + msg.chosenAmount);
          selectedPlayer.classList.add("btn-player-confirmed");
          selectedAmount.classList.add("btn-amount-confirmed");
          disableBets();
        } else {
